...
export default function CreatePostScreen() {
  ...
  const onPost = async () => {
    ...
    try {
      ...
      Alert.alert("Error", e.message || "Could not create post. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      ...
      <View style={{ paddingHorizontal: 24, paddingTop: 24, gap: 20 }}>
        ...
        <TouchableOpacity
          ...
          style={{
            padding: 16,
            backgroundColor: loading || (!content.trim() && !imageUri) ? "#9333ea" : "#7c3aed",
            borderRadius: 12,
            marginTop: 8,
            shadowColor: "#7c3aed",
        ...
        <View style={{ 
          ...
          <Text style={{ fontSize: 13, color: "#6b7280", lineHeight: 18 }}>
            💡 <Text style={{ fontWeight: "600" }}>Tip:</Text> Add a photo to make your post stand out!
          </Text>
        </View>
      </View>
    </ScrollView>
